...
const Popup = ({ ip_nodo, id_nodo, togglePopupD, handleDelete }) => {
    ...
    <div className="popup-box-delete">
      <div className="box-delete">
        <div className='div-popup-delete'>
          ...
          <p className='subtitle-popup'>La dirección {ip_nodo} dejará de ser monitoreada y será eliminada de los registros.</p>
